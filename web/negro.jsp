<%-- 
    Document   : negro
    Created on : 9/05/2021, 02:12:37 AM
    Author     : Valdez
--%>
...
<html>
  ...
  <div class="card-header">
      <B>  Earl Grey con Bergamonta</b>
  </div>
  <div class="card-body">
      <img src="IMG/BERGAMONTA.PNG" width="150px" height="150px" >

    <p class="card-text">
        Té negro con esencia a bergamota: un té <BR>clásico inglés elaborado para aquellos<BR> paladares de buen gusto
...
<a class="btn btn-primary" aria-current="page" href="Controlador?accion=home">COMPRAR</a>
             ...
             <div class="card"  >
  <div class="card-header">
      <B> Te negro de Kenia</b>
  </div>
  <div class="card-body">
      <img src="IMG/KENIA.PNG" width="150px" height="150px" >

    <p class="card-text">
        
        Té negro de Kenia con chispas de<BR> chocolate, trozos de almendras<BR> con un toque a crema
