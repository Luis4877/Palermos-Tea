<%-- 
    Document   : rooibos
    Created on : 9/05/2021, 02:21:05 AM
    Author     : Valdez
--%>
...
Rooibos caramel</b>
  ...
  <div class="card-body">
      <img src="IMG/CARAMEL.PNG" width="150px" height="150px" >

    <p class="card-text">
     El Rooibos sudafricano se aromatiza con <br>caramelo para después mezclarse con trocitos<br>de almendras caramelizadas. La infusión puede <br>beberse fría o caliente.
